<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmSupplierMaintenance.aspx.cs" Inherits="CUBIC_CIBT_Project.FrmSupplierMaintenance" %>
			...
			<div class="container-fluid">
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 page-heading-cubic"><i class="fa fa-file"></i>&nbsp;&nbsp;Supplier Maintenance</h6>
					</div>

					<div class="card-body">
						<asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="#813838" ShowModelStateErrors="True" BackColor="#FEE2E1" Font-Names="Segoe UI Symbol" EnableTheming="True" EnableSupplierScript="True" />

						<div class="row row-margin-btm-cubic">
							<div class="form-group col-md-4">
								<asp:Label ID="lblSupplierddl" runat="server" Text="Select Mode" class="input-label-cubic"></asp:Label>
								<asp:DropDownList ID="ddlSupplierMode" runat="server" AutoPostBack="true" class="form-control" ValidateRequestMode="Enabled" BackColor="white" Style="border: 1px solid; font-size: 16px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; min-width: 140px;" OnSelectedIndexChanged="ddlSupplierMode_SelectedIndexChanged">
							...
							<div class="form-group col-md-2">
								<asp:CompareValidator ID="CompareValidator2" runat="server" Operator="Equal" ControlToValidate="ddlSupplierMode" ValueToCompare="" Errormessage="Please select a Mode" ForeColor="Red" BorderStyle="None" Display="Dynamic">*</asp:CompareValidator>
							</div>

							<div class="form-group col-md-4">
								<asp:Label ID="lblSupplierID" runat="server" Text="Supplier ID" class="input-label-cubic" Visible="false"></asp:Label>
								<asp:DropDownList ID="DrpListSupplierID" Visible="false" runat="server" AutoPostBack="true" class="form-control" ValidateRequestMode="Enabled" BackColor="white" Style="border: 1px solid; font-size: 16px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; min-width: 140px;">
									<asp:ListItem Value="">--Select One--</asp:ListItem>
								</asp:DropDownList>
							</div>
							<div class="form-group col-md-2">
								<asp:CompareValidator ID="CompareValidator1" runat="server" Operator="Equal" ControlToValidate="DrpListSupplierID" ValueToCompare="" Errormessage="Please select a Supplier ID" ForeColor="Red" BorderStyle="None" Display="Dynamic">*</asp:CompareValidator>
							</div>
						</div>
						<%-- row Supplier Name/ Status--%>
						<div class="row row-margin-btm-cubic">
							<div class="form-group col-md-4">
								<asp:Label ID="lblSupplierUsername" runat="server" Text="Supplier Username" class="input-label-cubic"></asp:Label>
								<asp:TextBox ID="txtSupplierUsername" runat="server" class="form-control input-text-cubic-14" ReadOnly="True" placeholder="Supplier Username"></asp:TextBox>

							</div>
							<div class="form-group col-md-2">
								<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSupplierUsername" ErrorMessage="Please enter Supplier Username" ForeColor="Red" BorderStyle="None">*</asp:RequiredFieldValidator>
							</div>
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 page-heading-cubic"><i class="fa fa-file"></i>&nbsp;&nbsp;Supplier Table</h6>
					</div>
					<div class="card-body">
